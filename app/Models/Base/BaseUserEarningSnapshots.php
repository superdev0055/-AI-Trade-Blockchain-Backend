 ...
 */
class BaseUserEarningSnapshots extends Model
{
    use HasFactory, ModelTrait;

    protected $table = 'user_earning_snapshots';
    protected string $comment = '';
    protected $fillable = ['users_id', 'datetime', 'earning'];
